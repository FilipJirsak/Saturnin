                ...
                <TabsContent value="editor" className="mt-4">
                  ...
                  {isEditing && (
                      <Alert className="mt-3" variant="destructive">
                        ...
                        <AlertDescription>
                          V režimu editace metadat je editor myšlenkové mapy uzamčen. Uložte změny pro možnost úpravy obsahu mapy.
                        </AlertDescription>
                      </Alert>
                  )}
                </TabsContent>
