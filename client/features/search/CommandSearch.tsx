...
import { File, FileText, Link, Loader2, Plus, Search, Settings, Upload } from "lucide-react";
import {
  CommandDialog,
  CommandEmpty,
  CommandGroup,
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <CommandInput
            ...
            className={cn(
              "border-none focus:ring-0 focus-visible:ring-0 focus-visible:border-none",
              isDragging && "!h-20",
            )}
          />
        </div>
              ...
              {results
                ...
                .map((result) => (
                  ...
                  >
                    ...
                    {result.id === "settings" && <CommandShortcut>⌘P</CommandShortcut>}
                  </CommandItem>
                ))}
            </CommandGroup>
          )}
