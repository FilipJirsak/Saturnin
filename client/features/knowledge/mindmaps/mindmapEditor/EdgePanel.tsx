      ...
      <div className="p-2 border-t bg-muted/10">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex gap-2 flex-wrap flex-1">
            ...
            >
              <SelectTrigger className="h-8 text-xs w-32"><SelectValue placeholder="Styl čáry"/></SelectTrigger>
              <SelectContent>
                {LINE_STYLES.map(s => (
            ...
            <Select
                value={currentColor}
                onValueChange={value => updateEdge(selectedEdge.id, {
                  style: { ...selectedEdge.style, stroke: value }
                })}
            >
              <SelectTrigger className="h-8 text-xs w-32"><SelectValue placeholder="Barva"/></SelectTrigger>
              <SelectContent>
                {EDGE_COLORS.map(c => (
