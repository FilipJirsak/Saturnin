...
import { searchDocuments, filterDocumentsBySearchTerm } from '~/utils/knowledge/documentSearchUtils';
import type { DocumentItem } from '~/types/knowledge';

describe('documentSearchUtils', () => {
  const docs = [
    { id: '1', type: 'document' as const, title: 'Alpha', description: 'desc', tags: ['foo'], lastModified: '', path: '/1' },
    { id: '2', type: 'document' as const, title: 'Beta', description: 'desc2', tags: ['bar'], lastModified: '', path: '/2' },
    { id: '3', type: 'folder' as const, title: 'Folder', description: '', tags: [], lastModified: '', path: '/3', children: [
      { id: '4', type: 'document' as const, title: 'Gamma', description: 'desc3', tags: ['baz'], lastModified: '', path: '/4' }
    ] }
  ] as DocumentItem[];
